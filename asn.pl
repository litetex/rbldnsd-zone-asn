...
# Based on https://github.com/rspamd/rspamd/blob/master/utils/asn.pl
...
my %config = (
  # https://www.arin.net/reference/research/statistics/nro_stats/
  # Updated daily
  asn_sources => [
  ...
  # Update every 8h
  bgp_sources => ['https://data.ris.ripe.net/rrc00/latest-bview.gz']
);
...
my $v6                  = 1;
my $parse               = 1;
my $v4_zone             = "asn.example.org";
my $v6_zone             = "asn6.example.org";
my $v4_file             = "asn.zone";
my $v6_file             = "asn6.zone";
my $ns_servers          = [ "asn-ns.example.org" ];
...
my $zone_header = << "EOH";
\$SOA 43200 $ns_servers->[0] support.example.org 0 600 300 86400 300
\$NS  43200 $ns_list
EOH
...
asn.pl [options]
 ...
 Options:
   ...
   --zone-v4              IPv4 zone (default: asn.example.org)
   --zone-v6              IPv6 zone (default: asn6.example.org)
